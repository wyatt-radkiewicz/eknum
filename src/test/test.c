...
#define VALIDATE(name, type, expected_base, number) \
	static bool test_validate_##name(unsigned test_id) { \
...
static const test_t tests[] = {
	TEST_ADD(test_validate_int1)
	TEST_ADD(test_validate_int2)
	TEST_ADD(test_validate_int3)
	TEST_ADD(test_validate_int4)
	TEST_ADD(test_validate_int_neg1)
	TEST_ADD(test_validate_int_neg2)
	TEST_ADD(test_validate_int_neg3)
	TEST_ADD(test_validate_inthex1)
	TEST_ADD(test_validate_inthex2)
	TEST_ADD(test_validate_inthex3)
	TEST_ADD(test_validate_inthex_neg1)
	TEST_ADD(test_validate_inthex_neg2)
	TEST_ADD(test_validate_inthex_neg3)
	TEST_ADD(test_validate_intoct1)
	TEST_ADD(test_validate_intoct2)
	TEST_ADD(test_validate_intoct3)
	TEST_ADD(test_validate_intoct_neg1)
	TEST_ADD(test_validate_intoct_neg2)
	TEST_ADD(test_validate_intoct_neg3)
	TEST_ADD(test_validate_intbin1)
	TEST_ADD(test_validate_intbin2)
	TEST_ADD(test_validate_intbin3)
	TEST_ADD(test_validate_intbin_neg1)
	TEST_ADD(test_validate_intbin_neg2)
	TEST_ADD(test_validate_intbin_neg3)
	TEST_PAD
	TEST_ADD(test_validate_uint1)
	TEST_ADD(test_validate_uint2)
	TEST_ADD(test_validate_uint3)
	TEST_ADD(test_validate_uint4)
	TEST_ADD(test_validate_uinthex1)
	TEST_ADD(test_validate_uinthex2)
	TEST_ADD(test_validate_uinthex3)
	TEST_ADD(test_validate_uintoct1)
	TEST_ADD(test_validate_uintoct2)
	TEST_ADD(test_validate_uintoct3)
	TEST_ADD(test_validate_uintbin1)
	TEST_ADD(test_validate_uintbin2)
	TEST_ADD(test_validate_uintbin3)
};
